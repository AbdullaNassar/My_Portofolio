...
function Skills() {
  return (
    <div>
      ...
      <div className=" mx-4 mb-20 mt-8 grid grid-cols-skill gap-8 sm:mx-0 sm:px-24">
        <SkillItem
          name={"Javascript"}
        ...
        />
        <SkillItem name={"Node.js"} srcImage={node} />
        <SkillItem name={"MongoDB"} srcImage={mongo} />
        <SkillItem name={"Express.js"} srcImage={express} />
